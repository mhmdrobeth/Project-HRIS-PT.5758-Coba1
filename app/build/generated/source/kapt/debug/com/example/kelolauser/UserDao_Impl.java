  ...
  public UserDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUser = new EntityInsertionAdapter<User>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `users` (`id`,`name`,`email`,`password`,`role`,`department`,`status`,`initial`) VALUES (nullif(?, 0),?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        if (entity.getInitial() == null) {
          ...
          statement.bindString(8, entity.getInitial());
        }
      }
    };
    ...
    this.__updateAdapterOfUser = new EntityDeletionOrUpdateAdapter<User>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `users` SET `id` = ?,`name` = ?,`email` = ?,`password` = ?,`role` = ?,`department` = ?,`status` = ?,`initial` = ? WHERE `id` = ?";
      }
  ...
  public List<User> getAll() {
    ...
    try {
      ...
      while (_cursor.moveToNext()) {
        ...
        _item = new User(_tmpId,_tmpName,_tmpEmail,_tmpPassword,_tmpRole,_tmpDepartment,_tmpStatus,_tmpInitial);
        _result.add(_item);
      }
      return _result;
    } finally {
  ...
  public User getUserByEmail(final String email) {
    ...
    try {
      ...
      if (_cursor.moveToFirst()) {
        ...
        _result = new User(_tmpId,_tmpName,_tmpEmail,_tmpPassword,_tmpRole,_tmpDepartment,_tmpStatus,_tmpInitial);
      } else {
        _result = null;
      }
      return _result;
